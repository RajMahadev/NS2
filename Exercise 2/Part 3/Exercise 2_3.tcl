...
set tracefile1 [open out2_3.tr w]
$ns trace-all $tracefile1
# Open the NAM trace file
set namfile [open out2_3.nam w]
$ns namtrace-all $namfile

set log [open log2_3.txt w]
set window [open window2_3.txt w]
...
proc finish {} {
	...
	close $namfile
	# exec nam out2_1.nam &
	exec perl ThroughputTCP.pl out2_3.tr 2 0.2 > thpTCP.txt
...
# Sample the bottleneck queue every 0.1 sec. Store the trace in qm2_3.out
set qmon [$ns monitor-queue $n0 $n1 [open qm2_3.out w] 0.1];
