...
set tracefile1 [open out1_1.tr w]
$ns trace-all $tracefile1
# Open the NAM trace file
set namfile [open out1_1.nam w]
$ns namtrace-all $namfile

set window [open window1_1.txt w]
...
proc finish {} {
	...
	close $namfile
	# exec nam out1_1.nam &
	exec perl ThroughputTCP.pl out1_1.tr 1 0.2 > thpTCP.txt
...
set qmon [$ns monitor-queue $n4 $n3 [open qm1_1.out w] 0.1];
