...
set tracefile1 [open out1_4b.tr w]
$ns trace-all $tracefile1
# Open the NAM trace file
set namfile [open out1_4b.nam w]
$ns namtrace-all $namfile

set window [open window1_4b.txt w]
...
proc finish {} {
	...
	close $namfile
	# exec nam out1_2.nam &
	exec perl ThroughputTCP.pl out1_4b.tr 1 0.2 > thpTCP.txt
	exec perl ThroughputUDP.pl out1_4b.tr 7 0.2 > thpUDP.txt
...
set qmon [$ns monitor-queue $n4 $n3 [open qm1_4b.out w] 0.1];
