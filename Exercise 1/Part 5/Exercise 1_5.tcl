...
set tracefile1 [open out1_5.tr w]
$ns trace-all $tracefile1
# Open the NAM trace file
set namfile [open out1_5.nam w]
$ns namtrace-all $namfile

set window [open window1_5.txt w]
...
proc finish {} {
	...
	close $namfile
	# exec nam out1_2.nam &
	exec perl ThroughputTCP.pl out1_5.tr 1 0.2 > thpTCP.txt
	exec perl ThroughputUDP.pl out1_5.tr 7 0.2 > thpUDP.txt
...
set qmon [$ns monitor-queue $n4 $n3 [open qm1_5.out w] 0.1];
