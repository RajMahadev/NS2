...
set tracefile1 [open out1_6c.tr w]
$ns trace-all $tracefile1
# Open the NAM trace file
set namfile [open out1_6c.nam w]
$ns namtrace-all $namfile

set window1 [open window1_6c.txt w]
set window8 [open window1_6c_8.txt w]
set window9 [open window1_6c_9.txt w]
set window10 [open window1_6c_10.txt w]
set window11 [open window1_6c_11.txt w]
...
proc finish {} {
	...
	close $namfile
	# exec nam out1_2.nam &
	exec perl Throughput.pl out1_6c.tr 1 1 0.2 > thpTCP.txt
	exec perl Throughput.pl out1_6c.tr 7 2 0.2 > thpUDP0.txt
	exec perl Throughput.pl out1_6c.tr 8 8 0.2 > thpTCP8.txt
	exec perl Throughput.pl out1_6c.tr 9 9 0.2 > thpTCP9.txt
	exec perl Throughput.pl out1_6c.tr 10 10 0.2 > thpTCP10.txt
	exec perl Throughput.pl out1_6c.tr 11 11 0.2 > thpTCP11.txt
	exec perl Throughput.pl out1_6c.tr 7 12 0.2 > thpUDP12.txt
	exec perl Throughput.pl out1_6c.tr 7 13 0.2 > thpUDP13.txt
	exec perl Throughput.pl out1_6c.tr 7 14 0.2 > thpUDP14.txt
	exec perl Throughput.pl out1_6c.tr 7 15 0.2 > thpUDP15.txt
...
set qmon [$ns monitor-queue $n4 $n3 [open qm1_6c.out w] 0.1];
